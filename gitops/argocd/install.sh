...
echo ""
echo "2. Faça build e push das imagens para o ECR (via GitHub Actions)"
echo "   - Dispare os workflows de analytics/auth/evaluation/flag/targeting"
echo "   - Aguarde finalizar o job push_ecr"
echo ""
echo "3. Edite as Applications em gitops/apps/ com a URL do seu repositório:"
echo "   sed -i 's|<seu-usuario>/<seu-repo>|seu-usuario/seu-repo|g' gitops/apps/*.yaml"
echo ""
echo "4. Aplique as Applications:"
